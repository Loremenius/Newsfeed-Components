...
*/
function createElement(title,date,p1,p2,p3){
...
data.forEach((item)=>{
  ...
  console.log(article)
  article.appendChild(createElement(item.title,item.date,item.firstParagraph,item.secondParagraph,item.thirdParagraph));
});